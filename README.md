...
Displays the top career matches based on **Semantic Vector Similarity** (BERT + FAISS) rather than simple keyword matching.
![Job Recommendations](src/assets/jopR.png)
